...
def getAlignment(wildcards):
    ...
    """
    if (
        "rna" not in config["samples"][wildcards.sample]
        or config["samples"][wildcards.sample]["rna"] == None
    ):
...
def getTumorContent(wildcards):
    ...
    """
    if (
        "tumorContent" in config["samples"][wildcards.sample]
        and config["samples"][wildcards.sample]["tumorContent"] != None
    ):
...
def checkCNV(wildcards):
    ...
    """
    if (
        config["cancer_analysis"]
        and "cnv" in config["samples"][wildcards.sample]
        and config["samples"][wildcards.sample]["cnv"] != None
    ):
...
def checkMethyl(wildcards):
    ...
    if (
        config["cancer_analysis"]
        and "methyl" in config["samples"][wildcards.sample]
        and config["samples"][wildcards.sample]["methyl"] != None
    ):
...
def checkTFBS(wildcards):
    ...
    if (
        config["cancer_analysis"]
        and "phase" in config["samples"][wildcards.sample]
        and config["samples"][wildcards.sample]["phase"] != None
    ):
...
def checkSomaticSnv(wildcards):
    ...
    if (
        config["cancer_analysis"]
        and "somatic_snv" in config["samples"][wildcards.sample]
        and config["samples"][wildcards.sample]["somatic_snv"] != None
    ):
...
def checkSomaticIndel(wildcards):
    ...
    if (
        config["cancer_analysis"]
        and "somatic_indel" in config["samples"][wildcards.sample]
        and config["samples"][wildcards.sample]["somatic_indel"] != None
    ):
...
def checkTissue(wildcards):
    ...
    if (
        config["cancer_analysis"]
        and "tissueType" in config["samples"][wildcards.sample]
        and config["samples"][wildcards.sample]["tissueType"] != None
        and config["samples"][wildcards.sample]["tissueType"] in possibleTissue
    ):
